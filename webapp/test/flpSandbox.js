		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori Application OData V2 NorthWind Service",
									"targetURL": "#fioriv2northwind-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fioriv2northwind-display": {
								"semanticObject": "fioriv2northwind",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fioriv2northwind",
									"url": sap.ui.require.toUrl("fioriv2northwind")
								}
							}
						}
					}
